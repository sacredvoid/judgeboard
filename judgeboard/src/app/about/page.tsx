      ...
      <div className="mt-8 space-y-8 leading-relaxed text-ink-secondary">
        ...
        <section>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5">
            <li>
              <strong className="text-ink">Senior engineers and designers</strong> who want to give
              back to the developer community by mentoring the next generation.
            </li>
            <li>
              <strong className="text-ink">Professionals building immigration portfolios</strong>{" "}
              — if you&apos;re pursuing an O-1A visa or EB-1 green card, documented judging at
              recognized events is valuable evidence of extraordinary ability.
            </li>
            <li>
              <strong className="text-ink">Industry experts</strong> curious about the hackathon
              scene and interested in evaluating cutting-edge projects in their field.
            </li>
          </ul>
        </section>
        ...
        <section id="submit">
          ...
          <p className="mt-3">
            Know of a hackathon looking for judges or mentors? We&apos;d love to add it. Email us
            with the event name, dates, location, and a link to the judge/mentor application page.
          </p>
          <a
