    ...
    <div>
      ...
      <section className="bg-gradient-to-b from-indigo-50 to-white py-16">
        <div className="mx-auto max-w-6xl px-6 text-center">
          ...
          <div className="mt-6 inline-flex items-center rounded-full bg-indigo-50 border border-indigo-100 px-4 py-2 text-sm text-indigo-700">
            Building your O-1A / EB-1 portfolio? We highlight immigration-eligible judging opportunities.
          </div>
        </div>
      </section>
